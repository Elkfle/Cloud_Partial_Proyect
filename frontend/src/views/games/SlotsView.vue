            ...
            <div class="relative">
                ...
                <div class="flex items-center justify-center py-5 gap-10">
                    ...
                    <button id="btn_spin" @click="spin" :disabled=isSpinning
                        ...
                        <img class="w-28 shadow-" src="lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/actionStart.png"
                            alt="">
                    </button>
                    <div class="flex items-center justify-center gap-2 flex-col text-center text-white">
...
.border_image {
    border-width: 1em;
    border-style: solid;
    border-image: url('lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/borderSlots.jpg') 30 30 round;
}
...
.background_slot {
    ...
    background-image: url('lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/wallpaper-macchu.png');
...
export default {
    data() {
        return {
            baseURL: "lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800",
            symbols: [
                { name: 'logo1', imageUrl: 'lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/logo1.png', multiplier: 10 },
                { name: 'logo2', imageUrl: 'lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/logo2.png', multiplier: 8 },
                { name: 'logo3', imageUrl: 'lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/logo3.png', multiplier: 5 },
                { name: 'logo4', imageUrl: 'lb-prod-proy-167809630.us-east-1.elb.amazonaws.com:8800/api/static/games/slotsGame/logo4.png', multiplier: 2 },
            ],
    ...
    methods: {
        async spin() {
            ...
            try {
                const response = await userAPI.post(`/users/${this.$store.getters.user_data.id}/update_balance`, { balance: this.balance });
        ...
        async updateBalance(newBalance) {
            try {
                const response = await userAPI.post(`/users/${this.$store.getters.user_data.id}/update_balance`, { balance: newBalance });
